...
<pre>
spec.new(<a href="#spec.new-expression">expression</a>, <a href="#spec.new-syntax">syntax</a>, <a href="#spec.new-cls_name">cls_name</a>, <a href="#spec.new-_fail">_fail</a>)
</pre>
...
| <a id="spec.new-cls_name"></a>cls_name |  the version class to use (one of [`Versions.VERSIONS`]).   |  `"semver"` |
